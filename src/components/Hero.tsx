      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-left pl-8 md:pl-12">
          <h1 className="font-handwritten font-bold text-4xl sm:text-5xl md:text-7xl lg:text-8xl mb-12 animate-fade-in leading-relaxed text-[#1a1a1a]">
            {/* Scratched out "typ" */}
            <span className="block relative mb-2 transform -rotate-2" style={{ marginLeft: '-20px' }}>
              <span className="relative inline-block opacity-60">
                typ
                <svg className="absolute top-1/2 left-0 w-full" height="4" viewBox="0 0 100 4" preserveAspectRatio="none">
                  <path d="M0,2 Q20,1 40,2.5 Q60,1.5 80,2 L100,2" stroke="#1a1a1a" strokeWidth="2.5" fill="none" strokeLinecap="round" />
                </svg>
              </span>
            </span>
            ...
            <span className="block text-[#1a1a1a] transform rotate-0.5 relative mb-3">
              selling dope{" "}
